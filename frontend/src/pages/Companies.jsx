                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-slate-500 mt-2">
                      {c.entity_type && <span>النوع: {c.entity_type}</span>}
                      ...
                      {c.employee_name && <span>الموظف: {c.employee_name}</span>}
                      {c.funding_entity_name && <span>جهة التمويل: {c.funding_entity_name}</span>}
                    </div>
                  </div>
