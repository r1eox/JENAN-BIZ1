...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || 'Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø¯Ø®ÙˆÙ„ ØºÙŠØ± ØµØ­ÙŠØ­Ø©');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col lg:flex-row" dir="ltr">
      ...
      {/* â”€â”€ Ø§Ù„Ø¬Ø§Ù†Ø¨ Ø§Ù„Ø£ÙŠØ³Ø±: Ù†Ù…ÙˆØ°Ø¬ Ø§Ù„Ø¯Ø®ÙˆÙ„ â”€â”€ */}
      <section
      ...
      >
        <div className="w-full max-w-[400px] rounded-[24px] bg-white/95 border border-white shadow-[0_20px_60px_rgba(15,23,42,0.16)] px-6 py-5 backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-extrabold text-slate-800 text-center">ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„</h2>
          <p className="text-xs text-slate-500 text-center mt-1 mb-4">Ø£Ø¯Ø®Ù„ Ø¨ÙŠØ§Ù†Ø§ØªÙƒ Ù„Ù„ÙˆØµÙˆÙ„ Ø¥Ù„Ù‰ Ø§Ù„Ù…Ù†ØµØ©</p>
          ...
          <div className="text-center text-xs text-slate-500 mt-4">
            ...
            <Link to="/register" className="text-blue-700 hover:underline font-semibold">Ø³Ø¬Ù„ Ø§Ù„Ø¢Ù†</Link>
          </div>
        </div>
      </section>

      {/* â”€â”€ Ø§Ù„Ø¬Ø§Ù†Ø¨ Ø§Ù„Ø£ÙŠÙ…Ù†: Ø§Ù„Ù„ÙˆØ­Ø© Ø§Ù„Ø²Ø±Ù‚Ø§Ø¡ â”€â”€ */}
      <aside
        ...
        dir="rtl"
      >
        {/* Ù†Ù…Ø· Ø§Ù„Ø®Ø·ÙˆØ· Ø§Ù„Ù‚Ø·Ø±ÙŠØ© */}
        <div
        ...
        {/* Ø¹Ù„Ø§Ù…Ø© Ù…Ø§Ø¦ÙŠØ©: Jenan BIZ ÙƒØ§Ù…Ù„Ø©Ù‹ */}
        <div
        ...
        {/* Ø§Ù„Ø´Ø¹Ø§Ø± â€“ Ø£Ø¹Ù„Ù‰ Ø§Ù„ÙŠÙ…ÙŠÙ† */}
<div className="absolute top-5 right-5 z-10 leading-none select-none" dir="ltr">
        ...
        {/* Ø§Ù„Ù…Ø­ØªÙˆÙ‰ Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠ â€“ flex ÙŠÙ…Ù„Ø£ Ø§Ù„Ø´Ø§Ø´Ø© ÙƒØ§Ù…Ù„Ø§Ù‹ */}
        <div className="relative z-10 flex flex-col justify-between px-6 md:px-10 lg:px-14 text-right h-full" style={{ paddingTop: '4.5rem', paddingBottom: '1.5rem' }}>
          ...
          {/* Ø§Ù„Ù‚Ø³Ù… Ø§Ù„Ø¹Ù„ÙˆÙŠ: Ø§Ù„Ø¹Ù†ÙˆØ§Ù† ÙˆØ§Ù„ÙˆØµÙ */}
          <div>
            <p className="text-[10px] text-sky-300 mb-2 font-semibold tracking-[0.16em] uppercase">
              Ù…Ù†ØµØ© Ù…ØªÙƒØ§Ù…Ù„Ø© Â· ØªØ­Ù„ÙŠÙ„ ÙˆØ¥Ø¯Ø§Ø±Ø© Ø§Ù„Ø§Ø³ØªØ´Ø§Ø±Ø§Øª Ø§Ù„Ø¥Ø¯Ø§Ø±ÙŠØ©
            </p>

            <h1 className="text-[1.7rem] md:text-[2.2rem] font-extrabold leading-tight mb-1 text-white">Ø­Ù„ÙˆÙ„ Ø§Ù„Ø£Ø¹Ù…Ø§Ù„</h1>
            <h1 className="text-[1.7rem] md:text-[2.2rem] font-extrabold leading-tight mb-3 text-sky-300">Ø§Ù„Ù…ØªÙƒØ§Ù…Ù„Ø©</h1>

            <p className="text-blue-100/75 text-[11px] md:text-xs leading-[1.7] max-w-[400px]">
              ØªØ­Ù„ÙŠÙ„ ÙˆØ¥Ø¯Ø§Ø±Ø© Ø§Ù„Ø§Ø³ØªØ´Ø§Ø±Ø§Øª Ø§Ù„Ø¥Ø¯Ø§Ø±ÙŠØ©ØŒ ÙˆØªØ£Ù‡ÙŠÙ„ ÙˆØ¥Ø¹Ø§Ø¯Ø© Ù‡ÙŠÙƒÙ„Ø© Ø§Ù„Ù…Ù†Ø´Ø¢Øª Ø¨Ø§Ø­ØªØ±Ø§ÙÙŠØ© Ø¹Ø§Ù„ÙŠØ©.
            </p>
          </div>

          {/* Ø§Ù„Ù‚Ø³Ù… Ø§Ù„Ø£ÙˆØ³Ø·: ÙƒØªØ§Ø¨Ø§Øª Ù…ØªØ¯Ø±Ø¬Ø© Ù…Ù† Ø§Ù„ÙŠÙ…ÙŠÙ† Ù„Ù„ÙŠØ³Ø§Ø± */}
            ...
            <div className="max-w-[500px] w-full space-y-3">
              ...
              <div className="group w-full py-1.5 transition-all duration-300 hover:-translate-y-0.5">
                <div className="flex items-center gap-3 justify-end">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-white text-xs md:text-sm leading-tight transition-colors duration-300 group-hover:text-cyan-300">ØªØ­Ù„ÙŠÙ„ Ø°ÙƒÙŠ</p>
                    <p className="text-blue-100/65 text-[10px] md:text-[11px] leading-tight mt-1 transition-colors duration-300 group-hover:text-cyan-100">ØªØ­Ù„ÙŠÙ„ Ø°ÙƒÙŠ Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ù†Ø´Ø¢Øª ÙˆØ§Ù„ÙƒØ´ÙˆÙØ§Øª</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group w-full py-1.5 transition-all duration-300 hover:-translate-y-0.5">
                <div className="flex items-center gap-3 justify-end">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-white text-xs md:text-sm leading-tight transition-colors duration-300 group-hover:text-cyan-300">Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„Ù…Ø³ØªÙ†Ø¯Ø§Øª</p>
                    <p className="text-blue-100/62 text-[10px] md:text-[11px] leading-tight mt-1 transition-colors duration-300 group-hover:text-cyan-100">Ø±ÙØ¹ ÙˆØªÙ†Ø¸ÙŠÙ… Ù…Ù„ÙØ§Øª Ø§Ù„Ù…Ù†Ø´Ø£Ø© ÙˆØ§Ù„Ø¹Ù‚ÙˆØ¯</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group w-full py-1.5 transition-all duration-300 hover:-translate-y-0.5">
                <div className="flex items-center gap-3 justify-end">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-white text-xs md:text-sm leading-tight transition-colors duration-300 group-hover:text-cyan-300">Ù…ØªØ§Ø¨Ø¹Ø© Ø´Ø§Ù…Ù„Ø©</p>
                    <p className="text-blue-100/58 text-[10px] md:text-[11px] leading-tight mt-1 transition-colors duration-300 group-hover:text-cyan-100">Ù…ØªØ§Ø¨Ø¹Ø© Ø§Ù„Ø·Ù„Ø¨Ø§Øª ÙˆØ§Ù„Ø´Ø±ÙƒØ§Ø¡ ÙˆØ§Ù„ÙˆØ³Ø·Ø§Ø¡</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group w-full py-1.5 transition-all duration-300 hover:-translate-y-0.5">
                <div className="flex items-center gap-3 justify-end">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-white text-xs md:text-sm leading-tight transition-colors duration-300 group-hover:text-cyan-300">Ø¥Ø¹Ø§Ø¯Ø© Ù‡ÙŠÙƒÙ„Ø© Ø§Ù„Ù…Ù†Ø´Ø¢Øª</p>
                    <p className="text-blue-100/55 text-[10px] md:text-[11px] leading-tight mt-1 transition-colors duration-300 group-hover:text-cyan-100">ØªØ£Ù‡ÙŠÙ„ ÙˆØ¥Ø¹Ø§Ø¯Ø© Ù‡ÙŠÙƒÙ„Ø© Ø§Ù„Ù…Ù†Ø´Ø¢Øª ÙˆØ§Ù„Ø´Ø±ÙƒØ§Øª</p>
                  </div>
                </div>
              </div>
          ...
          <p className="text-[10px] text-blue-200/60 select-none">
            Â© Jenan BIZ 2026 â€” Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø­Ù‚ÙˆÙ‚ Ù…Ø­ÙÙˆØ¸Ø©
          </p>
        </div>
      </aside>
    </div>
